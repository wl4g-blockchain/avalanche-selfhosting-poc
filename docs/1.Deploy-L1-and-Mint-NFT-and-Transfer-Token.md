...
```bash
avalanche-cli blockchain create mygames1 --evm --latest --evm-chain-id 43113001 --evm-token MGA1 --evm-defaults
#✔ Proof Of Authority
...
```bash
avalanche-cli blockchain deploy mygames1 --local --icm-version 1.6.3
```
...
export INIT_ACCOUNT_ADDR1=0xD7e194aBC35B6F4896a1a98b64b15EDc10f309d4
